...
func TestRenderImage(t *testing.T) {
	...
	t.Run("successfully renders a PNG image from a Nyan cat", func(t *testing.T) {
		...
		err = RenderImage(decompressedImage, 16, 16, "cache/test-481.png")
		if err != nil {
			t.Fatalf("Failed to render image: %v", err)
		}

		expectedDecompressed := ""
		t.Log("decompressedImage", decompressedImage)
		t.Log("expectedDecompressed", expectedDecompressed)
		if decompressedImage != expectedDecompressed {
			t.Errorf("Decompressed image does not match expected value")
		}

		// Clean up the test file
		// os.Remove("cache/test-481.png")
	})
}
