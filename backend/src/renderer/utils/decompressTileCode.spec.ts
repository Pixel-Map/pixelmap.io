...
it("successfully decodes a Nyan cat", async () => {
	const compressedImage =
		// eslint-disable-next-line max-len
	...
	expect(decompressTileCode(compressedImage)).toBe(
		// eslint-disable-next-line max-len
		"",
	);
});
...
describe("decompressTileCode", () => {
	it("should decompress a compressed image string", () => {
		const compressedImage =
			"c#I@D;=i~W/FHHllD<NjB!e<#8;&ebh)TU|@kRfb(nH7v;D*!T%wAx0z&/~BN3e87=T4rwt=3rGMP3`HWD%n:4YybsE#mk}G8$M/)NHzs:K`q[ax#29/(va@+!)`)bq~Fa#|MPS_5D";
		const result = inflateCompressedData(compressedImage);
...
describe("decodeDataToString", () => {
	it("should decode 8-bit data to a string", () => {
		const result = decodeDataToString(
			new Uint8Array([
				8, 8, 8, 8, 8, 8, 8, 8, 8, 215, 8, 8, 8, 8, 8, 8, 8, 8, 215, 8, 8, 8, 8,
				8, 215, 8, 215, 8, 8, 8, 8, 8, 180, 180, 8, 8, 8, 8, 216, 216, 8, 215,
				8, 8, 8, 215, 8, 216, 180, 180, 180, 180, 180, 216, 129, 129, 216, 8, 8,
...
describe("expandColorEncoding", () => {
	it("should expand 8-bit data to a string", () => {
		const decodedString =
			"";
		// Try just expanding first
		const expanded = expandHexDoubles(decodedString);
		expect(expanded).toEqual(
			"",
		);
		const result = expandColorEncoding(decodedString, 8);
		expect(result).toEqual(
			"",
		);
	});
