...
//8bit color map
export const colors_8bit: [number, number, number][] = [
	[0, 0, 0],
	[0, 0, 48],
	[0, 0, 96],
	[0, 0, 144],
...
export function get4bitColor(index: number): [number, number, number] {
	// @ts-ignore
	return colors_4bit[index] || [0, 0, 0];
}

export function get8bitColor(index: number): [number, number, number] {
	return colors_8bit[index] || [0, 0, 0];
}

export function get4bitColorIndex(r: number, g: number, b: number): number {
	// Implementation to find the closest 4-bit color index
	// This is a placeholder and needs to be implemented
	return 0;
}

export function get8bitColorIndex(r: number, g: number, b: number): number {
	// Implementation to find the closest 8-bit color index
	// This is a placeholder and needs to be implemented
	return 0;
}

export function getClosest4bitColor(
	r: number,
	g: number,
	b: number,
): [number, number, number] {
	// Implementation to find the closest 4-bit color
	// This is a placeholder and needs to be implemented
	return [0, 0, 0];
}

export function getClosest8bitColor(
	r: number,
	g: number,
	b: number,
): [number, number, number] {
	// Implementation to find the closest 8-bit color
	// This is a placeholder and needs to be implemented
	return [0, 0, 0];
}
